...
const AddBlog = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    // You can extract the content using:
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex-1 bg-blue-50/50 text-gray-600 h-full overflow-scroll'>
      <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded mb-20'>
        ...
        <div className='max-w-lg h-74 pb-16 sm:pb-10 pt-2 relative border rounded'>
        ...
        <button disabled={isAdding}
         type="submit" className='mt-8 w-40 h-10 bg-blue-700 text-white rounded cursor-pointer text-sm'>
